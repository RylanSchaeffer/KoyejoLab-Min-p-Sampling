...
GPQA result (flexible-extract exact match, 4 samplers, no p-less): best-min-p minus best-other-sampler stays within about 0.01 at every N on all 16 models; slightly below on Qwen 0.5B, Mistral 7B Instruct, Gemma 9B; slightly above on Gemma 2B and Llama 3.2 3B; indistinguishable elsewhere. Same conclusion as GSM8K.
